...
//       await axios.post('http://localhost:8000/api/founder-details', founderPayload, {
...
//       await axios.post('http://localhost:8000/api/startup-details', startupFormData, {
//         headers: {
...
export default function StartupRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://8000-genaihackat-aianalystfe-hgc0ltv9os0.ws-us121.gitpod.io/api/founder-details', founderPayload, {
        headers: { Authorization: `Bearer ${token}` }
      });
...
await axios.post(
  'https://8000-genaihackat-aianalystfe-hgc0ltv9os0.ws-us121.gitpod.io/api/startup-details',
  startupData,
  {
    headers: {
      Authorization: `Bearer ${token}`,
